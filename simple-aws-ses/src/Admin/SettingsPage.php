...
class SettingsPage
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_simple_aws_ses_test_email', [$this, 'handleTestEmail']);
    }
